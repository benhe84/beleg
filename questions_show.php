	...
	if ($st->execute()){
		...
		if ($rows>0){
			...
			foreach ($st as $erg){
				...
				echo '<td><Form action="questions_edit.php" method="post"><input type="hidden" name="fnr" value='.$erg[0].' /><input type="Submit" value="Bearbeiten" name="edit"></form></td></tr>';
			}
			echo '</table>';
		}
